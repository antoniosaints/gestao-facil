-- Assinaturas recorrentes: domínio separado do módulo /assinatura da conta.
...
ALTER TABLE `PlanoAssinatura`
  ADD CONSTRAINT `PlanoAssinatura_contaId_fkey`
  FOREIGN KEY (`contaId`) REFERENCES `Contas`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE `PlanoAssinaturaItem`
  ADD CONSTRAINT `PlanoAssinaturaItem_planoId_fkey`
  FOREIGN KEY (`planoId`) REFERENCES `PlanoAssinatura`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `PlanoAssinaturaItem_servicoId_fkey`
  FOREIGN KEY (`servicoId`) REFERENCES `Servicos`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `PlanoAssinaturaItem_produtoId_fkey`
  FOREIGN KEY (`produtoId`) REFERENCES `Produto`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `AssinaturaCliente`
  ADD CONSTRAINT `AssinaturaCliente_contaId_fkey`
  FOREIGN KEY (`contaId`) REFERENCES `Contas`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaCliente_clienteId_fkey`
  FOREIGN KEY (`clienteId`) REFERENCES `ClientesFornecedores`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaCliente_planoId_fkey`
  FOREIGN KEY (`planoId`) REFERENCES `PlanoAssinatura`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `AssinaturaItem`
  ADD CONSTRAINT `AssinaturaItem_assinaturaId_fkey`
  FOREIGN KEY (`assinaturaId`) REFERENCES `AssinaturaCliente`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaItem_servicoId_fkey`
  FOREIGN KEY (`servicoId`) REFERENCES `Servicos`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaItem_produtoId_fkey`
  FOREIGN KEY (`produtoId`) REFERENCES `Produto`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `AssinaturaComodato`
  ADD CONSTRAINT `AssinaturaComodato_assinaturaItemId_fkey`
  FOREIGN KEY (`assinaturaItemId`) REFERENCES `AssinaturaItem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaComodato_produtoId_fkey`
  FOREIGN KEY (`produtoId`) REFERENCES `Produto`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE `AssinaturaCiclo`
  ADD CONSTRAINT `AssinaturaCiclo_assinaturaId_fkey`
  FOREIGN KEY (`assinaturaId`) REFERENCES `AssinaturaCliente`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaCiclo_cobrancaFinanceiraId_fkey`
  FOREIGN KEY (`cobrancaFinanceiraId`) REFERENCES `CobrancasFinanceiras`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaCiclo_lancamentoFinanceiroId_fkey`
  FOREIGN KEY (`lancamentoFinanceiroId`) REFERENCES `LancamentoFinanceiro`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `AssinaturaHistorico`
  ADD CONSTRAINT `AssinaturaHistorico_assinaturaId_fkey`
  FOREIGN KEY (`assinaturaId`) REFERENCES `AssinaturaCliente`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `AssinaturaHistorico_usuarioId_fkey`
