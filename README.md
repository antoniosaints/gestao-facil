...
- O módulo de ordens de serviço agora expõe faturamento da OS, estorno operacional do faturamento, geração de cobrança vinculada à ordem e bloqueio de exclusão quando existirem cobranças ativas ou status faturado.
