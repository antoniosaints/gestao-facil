...
- Webhooks do WhatsApp entram por `POST /api/whatsapp/webhooks/:instanceId`, sem JWT; a W-API identifica a instância pelo caminho e não repassa query/header de segredo. O endpoint persiste primeiro em `WhatsAppWebhookEvento`, e o worker MySQL processa contato, conversa e mensagem em transação.
