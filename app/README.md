...
- Mensagens de saída persistidas pelo atendimento trocam o ID temporário pelo `messageId` retornado pela W-API. O worker usa esse identificador para aplicar delivery/status, reconcilia payloads antigos e encerra deliveries não rastreados como ignorados após três tentativas.
