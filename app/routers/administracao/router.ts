...
routerAdminMain.get("/faturas/contas/select2", authenticateJWT, select2ContasAdmin);
routerAdminMain.post("/faturas/manual", authenticateJWT, createFaturaManualAdmin);
