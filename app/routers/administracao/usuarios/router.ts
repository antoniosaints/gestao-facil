...
import { deleteUsuario, getMinhaConexao, getUsuario, listagemMobileUsuarios, saveUsuario, tableUsuarios, toggleModeGerencial, updatePerfil, updateSenha } from "../../../controllers/administracao/usuarios";
...
routerUsuarios.post("/updateSenha", authenticateJWT, updateSenha);
