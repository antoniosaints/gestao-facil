  ...
  try {
    ...
    const parametros = await prisma.parametrosConta.upsert({
      ...
      create: {
        ...
        ...({
          osOcultarAssinatura: body.data.osOcultarAssinatura,
          osLancamentoAutomatico: body.data.osLancamentoAutomatico,
          osCategoriaFinanceiraId: body.data.osCategoriaFinanceiraId,
          osContaFinanceiraId: body.data.osContaFinanceiraId,
        } as any),
        temaPersonalizado: temaPersonalizado as any,
        estiloUi: body.data.estiloUi,
        ...
        ...({ etiquetaModelos: body.data.etiquetaModelos } as any),
