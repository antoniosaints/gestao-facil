...
function buildProdutoBaseResponse(
  ...
  return {
    ...
    icmsCsosn: base.icmsCsosn,
    icmsCst: base.icmsCst,
    icmsModBcSt: base.icmsModBcSt, icmsMva: base.icmsMva, icmsReducaoBcSt: base.icmsReducaoBcSt, icmsAliquotaSt: base.icmsAliquotaSt,
    fcpAliquota: base.fcpAliquota, fcpStAliquota: base.fcpStAliquota, icmsDesoneradoValor: base.icmsDesoneradoValor, icmsDesoneradoMotivo: base.icmsDesoneradoMotivo,
    icmsCreditoAliquota: base.icmsCreditoAliquota, ipiCst: base.ipiCst, ipiCodigoEnquadramento: base.ipiCodigoEnquadramento, difalAliquotaInterna: base.difalAliquotaInterna, difalFcpAliquota: base.difalFcpAliquota,
    pisCst: base.pisCst,
...
export const saveProduto = async (
  ...
  try {
    ...
    const fiscalData = {
      ...
      icmsModBcSt: data.icmsModBcSt, icmsMva: data.icmsMva, icmsReducaoBcSt: data.icmsReducaoBcSt, icmsAliquotaSt: data.icmsAliquotaSt,
      fcpAliquota: data.fcpAliquota, fcpStAliquota: data.fcpStAliquota, icmsDesoneradoValor: data.icmsDesoneradoValor, icmsDesoneradoMotivo: data.icmsDesoneradoMotivo,
      icmsCreditoAliquota: data.icmsCreditoAliquota, ipiCst: data.ipiCst, ipiCodigoEnquadramento: data.ipiCodigoEnquadramento, difalAliquotaInterna: data.difalAliquotaInterna, difalFcpAliquota: data.difalFcpAliquota,
      pisCst: data.pisCst,
