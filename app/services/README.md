...
- Em `services/ourive`, o snapshot de preços do material preserva exatamente custo e valor confirmados na versão do orçamento, inclusive zero, sem reaplicar o cadastro atual do produto.
