...
export const OURIVE_CAPABILITIES = ["VISUALIZAR", "RECEBER", "ORCAMENTO", "PRODUCAO", "REVISAO", "ENTREGAR", "EQUIPE", "RELATORIOS", "CONFIGURAR", "FINANCEIRO"] as const;
...
const permissions: Record<OurivePapel, OuriveCapability[]> = {
  ...
  ATENDIMENTO: ["VISUALIZAR", "RECEBER", "ORCAMENTO"],
  OURIVE: ["VISUALIZAR", "PRODUCAO"],
