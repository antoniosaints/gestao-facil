...
export const ProdutoSchema = z.object({
  ...
  mostrarNoCatalogo: parseBoolean("mostrarNoCatalogo", true).optional().nullable(),
  ...
  ean: parseOptionalText("ean").nullable(),
  tipoItem: parseOptionalText("tipoItem").nullable(),
  icmsCsosn: parseOptionalText("icmsCsosn").nullable(),
  icmsCst: parseOptionalText("icmsCst").nullable(),
  icmsModBcSt: parseOptionalText("icmsModBcSt").nullable(),
  icmsMva: parseDecimal("icmsMva").optional().nullable(),
  icmsReducaoBcSt: parseDecimal("icmsReducaoBcSt").optional().nullable(),
  icmsAliquotaSt: parseDecimal("icmsAliquotaSt").optional().nullable(),
  fcpAliquota: parseDecimal("fcpAliquota").optional().nullable(),
  fcpStAliquota: parseDecimal("fcpStAliquota").optional().nullable(),
  icmsDesoneradoValor: parseDecimal("icmsDesoneradoValor").optional().nullable(),
  icmsDesoneradoMotivo: parseOptionalText("icmsDesoneradoMotivo").nullable(),
  icmsCreditoAliquota: parseDecimal("icmsCreditoAliquota").optional().nullable(),
  ipiCst: parseOptionalText("ipiCst").nullable(),
  ipiCodigoEnquadramento: parseOptionalText("ipiCodigoEnquadramento").nullable(),
  difalAliquotaInterna: parseDecimal("difalAliquotaInterna").optional().nullable(),
  difalFcpAliquota: parseDecimal("difalFcpAliquota").optional().nullable(),
  pisCst: parseOptionalText("pisCst").nullable(),
  cofinsCst: parseOptionalText("cofinsCst").nullable(),
